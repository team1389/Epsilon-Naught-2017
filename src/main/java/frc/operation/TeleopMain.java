...
public class TeleopMain {
	...
	private Subsystem setupSimpleIntakeSystem(){
		return new SimpleGearIntakeSystem(controls.aButton(), controls.leftStickYAxis(), controls.rightTrigger(), robot.armElevator.getVoltageController(), robot.gearIntake.getVoltageController());
	}
	/**
	 * 
