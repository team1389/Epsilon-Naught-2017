...
public class PiVisionManager implements CompositeWatchable
{
	...
	/**
	 * the robot is intended to control the state of this value, using the
	 * processing flag to tell the pi to initiate vision calculations. This method
	 * is intended to allow the user to verify that the pi is being told to do
	 * processing
	 * 
	 * @return true if
	 */
	...
	/**
	 * @return true if the pi has adequate vision of the target to complete vision
	 *         calculations
	 */
	...
	/**
	 * queries the network table for the latest angle calculation and the time stamp
	 * it was observed, for latency compensation
	 * 
